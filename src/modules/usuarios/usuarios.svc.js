(function(ng){
    ...
    mod.service('usuariosService', function($http){
    	...
    	this.actualizarUsuario = function(usuario) {
        	return $http.put('https://bf42.herokuapp.com/api/usuarios/' + usuario.id + "/", usuario)
        ...
        this.volverAdmin = function(usuario) {
            return $http.get('https://bf42.herokuapp.com/api/volverAdmin/' + usuario.id + "/").then(
                    function(response) {
                        return response['data'];
                    })
        }
        ...
        this.volverFuncionario = function(usuario) {
            return $http.get('https://bf42.herokuapp.com/api/volverFuncionario/' + usuario.id + "/").then(
                    function(response) {
                        return response['data'];
                    })
        }
